...
protected:
    ...
    void TestCases(){
        //0
        CASE(N = 5, M = 4, C = 2, Q = 4, generateSubtask0(A, B, W, V, op, data));
        //1
        CASE(N = 8, M = 10, C = 2, Q = 6, generateSubtask1(A, B, W, V, op, data));
        //2
        CASE(N = 10, M = 15, C = 3, Q = 8, generateSubtask2(A, B, W, V, op, data));
        //4
        CASE(N = 316,    M = 99540,  C = 1,     randomGraph(N, M, A, B), randomArray(V, N, 1, 1000000), randomArray(W, N, 1, C), Q = 2000,   randomQuery(op, data, Q, 2, N, 10000));
